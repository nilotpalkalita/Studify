...
<table>
  <tr>
   <td align="left"><h1 align="right" class="heading">
   <h1 align="center" class="heading">Information Area </h1>
	 ...
	 $query="SELECT * FROM students";
		...
		<tr>
		<td><b>Name</b></td> <td><b>Roll No.</b></td><td><b>Total Percentage</b></td><td><b>Deparment</b></td></tr> ";
while($result=mysql_fetch_array($resource))
	{ 
	echo "<tr><td>".$result[1]."</td><td>".$result[2]."</td><td>".$result[3]."</td><td>".$result[4]."</td></tr>";
	} echo "</table>";
	 ?> 
      <h1 align="left" class="heading"><a href="indexd.html">Admin Login</a> </h1>
      </p>
